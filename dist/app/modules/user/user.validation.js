...
exports.userCreateZodSchema = zod_1.default.object({
    ...
    role: zod_1.default.enum([user_interface_1.IUserRole.user, user_interface_1.IUserRole.admin, user_interface_1.IUserRole.agent]).optional().default(user_interface_1.IUserRole.user),
...
exports.userUpdateZodSchema = zod_1.default.object({
    ...
    role: zod_1.default.enum([user_interface_1.IUserRole.user, user_interface_1.IUserRole.admin, user_interface_1.IUserRole.agent]).optional(),
