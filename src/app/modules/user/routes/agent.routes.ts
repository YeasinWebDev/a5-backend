...
agentRouters.get("/transactions",checkAuth(IUserRole.agent), userController.getAgentTransactions)
agentRouters.get("/stats", checkAuth(IUserRole.agent), userController.getAgentStats)